...
# Module version
version_str = "0.3.0.post362"
version_tuple = (0, 3, 0, 362)
try:
    from packaging.version import Version as V
    pversion = V("0.3.0.post362")
except ImportError:
    pass
...
# Tool version info
tool_version_str = "0.0.post141"
tool_version_tuple = (0, 0, 141)
try:
    from packaging.version import Version as V
    ptool_version = V("0.0.post141")
except ImportError:
    pass
